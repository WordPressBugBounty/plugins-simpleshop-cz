...
The SimpleShop WP plugin can be installed on a WordPress website with WP version 6.6 and higher or on a Mioweb website,
...
* content restriction – [instructions](https://podpora.redbit.cz/navod/nastaveni-simpleshop-pluginu-pro-wordpress/)
    * gradual release of entire pages and individual parts of the content
    * releasing the content in specific dates or in a number of days after registration
* automatic renewal of membership using repeated payments in the SimpleShop application – [instructions](https://podpora.redbit.cz/navod/opakovane-platby-a-omezeni-clenstvi)
* redirecting the user after logging in – [instructions](https://podpora.redbit.cz/navod/clenske-sekce-prihlaseni-a-presmerovani/)
...
You can install the plugin on WordPress 6.6 or higher. Furthermore, your site needs to run on a server with PHP 7.4 or higher.
